...
public enum DiagnosticMessage {
    ...
    ERROR_140("invalid name ''{0}'' found for data loader method. A data loader method name must be in the format of "
    ...
    ERROR_145("no matching ''{0}'' method ''{1}'' found for the GraphQL field ''{2}''. A data loader ''{0}'' "
                      + "method with the name ''{0}'' must be present in the service to use the data loader"),
