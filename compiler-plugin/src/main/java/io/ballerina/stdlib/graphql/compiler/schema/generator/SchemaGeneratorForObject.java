 ...
 */
public class SchemaGeneratorForObject {

    private static final String IF_ARG_NAME = "if";
    private static final String REASON_ARG_NAME = "reason";

    private final ObjectConstructorExpressionNode objectConstructorExpressionNode;
    private final InterfaceFinder interfaceFinder;
    private final Schema schema;
    private final SyntaxNodeAnalysisContext context;

    public SchemaGeneratorForObject(ObjectConstructorExpressionNode objectConstructorExpressionNode,
                                    InterfaceFinder interfaceFinder, String description,
                                    SyntaxNodeAnalysisContext context) {
        this.objectConstructorExpressionNode = objectConstructorExpressionNode;
    ...
    public Schema generate() {
        findRootTypes(this.objectConstructorExpressionNode);
    ...
    private void findRootTypes(ObjectConstructorExpressionNode objectConstructorExpressionNode) {
        List<MethodSymbol> methods = getMethods(objectConstructorExpressionNode);
    ...
    private List<MethodSymbol> getMethods(ObjectConstructorExpressionNode objectConstructorExpressionNode) {
