...
public enum CompilationDiagnostic {
    ...
    NO_MATCHING_METHOD_FOUND_FOR_LOAD_METHOD(DiagnosticMessage.ERROR_141, DiagnosticCode.GRAPHQL_141,
                                                    DiagnosticSeverity.ERROR),
    ...
    INVALID_DATA_LOADER_USAGE_IN_SUBSCRIPTION(DiagnosticMessage.ERROR_146, DiagnosticCode.GRAPHQL_146,
                                              DiagnosticSeverity.ERROR),
    INVALID_USAGE_OF_LOADER_ANNOTATION(DiagnosticMessage.ERROR_147, DiagnosticCode.GRAPHQL_147,
                                                             DiagnosticSeverity.ERROR),
    INVALID_FUNCTION_NAME_FOR_DATA_LOADER(DiagnosticMessage.ERROR_148, DiagnosticCode.GRAPHQL_148,
                                          DiagnosticSeverity.ERROR),
