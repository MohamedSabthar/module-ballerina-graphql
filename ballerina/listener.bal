...
public class Listener {
    ...
    public isolated function attach(Service s, string[]|string? name = ()) returns Error? {
        ...
        readonly & map<typedesc<Directive>> directives = getCustomExecutablenDirectives(serviceConfig);
        ...
        if graphiql.enabled {
            ...
            engine = check new (schemaString, maxQueryDepth, s, interceptors, introspection, directives);
