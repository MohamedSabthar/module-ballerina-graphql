    ...
    *parser:Visitor;
    ...
    public isolated function visitOperation(parser:OperationNode operationNode, anydata data = ()) {
        if operationNode.getKind() != parser:OPERATION_MUTATION {
            return self.visitSelectionsParallely(operationNode, operationNode.getKind());
        } 
    ...
    public isolated function visitFragment(parser:FragmentNode fragmentNode, anydata data = ()) {
        ...
        if operationType != parser:OPERATION_MUTATION {
            return self.visitSelectionsParallely(fragmentNode, operationType);
        }
    ...
    private isolated function visitSelectionsParallely(parser:SelectionParentNode selectionParentNode,
                                                       anydata data = ()) {
        future<()>[] futures = [];
